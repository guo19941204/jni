...
typedef void (*AudioBufferCallBack)(int8_t* pAudioBuffer, WebRtc_UWord32 bufLen); //add by robin获取声卡pcm数据的回调函数
typedef void (*RecAudioBufferCallBack)(int8_t* pAudioBuffer, WebRtc_UWord32 bufLen); //add by ck获取声卡pcm数据的回调函数
}  // namespace webrtc
